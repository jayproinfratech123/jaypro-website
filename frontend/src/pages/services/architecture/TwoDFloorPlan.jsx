        ...
        <div className="relative mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:py-20">
          ...
          <div className="max-w-3xl">
            ...
            <p
              ...
              "
            >
              Browse thoughtfully planned house layouts and
              2D floor plan concepts based on plot dimensions,
              home size, direction and building requirements.
            </p>
