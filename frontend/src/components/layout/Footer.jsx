...
const Footer = () => (
  ...
  <span className="font-display text-lg font-bold text-white">
    Jaypro <span className="text-red-500">Infratech</span>
  </span>
</Link>
        ...
        <div className="mt-5 flex gap-3">
          <a href="#" className="rounded-full border border-white/10 p-2 hover:border-red-500 hover:text-red-500">
      ...
      <div>
        <h4 className="mb-4 font-display text-sm font-semibold uppercase tracking-wide text-red-500">Company</h4>
      ...
      <div>
        <h4 className="mb-4 font-display text-sm font-semibold uppercase tracking-wide text-red-500">Services</h4>
        <ul className="space-y-2 text-sm text-concrete-200/80">
      ...
      <div>
        <h4 className="mb-4 font-display text-sm font-semibold uppercase tracking-wide text-red-500">Contact</h4>
        <ul className="space-y-3 text-sm text-concrete-200/80">
          <li className="flex items-center gap-2"><Phone className="h-4 w-4 text-red-500" /> +91  9835852462</li>
          <li className="flex items-center gap-2"><Phone className="h-4 w-4 text-red-500" /> +91  7277008312</li>
          <li className="flex items-center gap-2"><Mail className="h-4 w-4 text-red-500" /> info@jayproinfratech.com</li>
